...
export const KOTH_SPAWN_REGIONS: readonly KothSpawnRegionConfig[] = [
    ...
    },
    {
        ...
        sectors: [
            createSector('D', 'north', 'west', [4131, 4132, 4133, 4134, 4135], 'D'),
            createSector('D', 'north', 'east', [4141, 4142, 4143, 4144, 4145], 'D'),
            createSector('D', 'south', 'west', [4231, 4232, 4233, 4234, 4235], 'D'),
            createSector('D', 'south', 'east', [4241, 4242, 4243, 4244, 4245], 'D'),
        ],
    },
    {
        regionId: 'E',
        ...
        defaultVariantSideByTeamId: { 1: 'west', 2: 'east' },
        sectors: [
            createSector('E', 'north', 'west', [5131, 5132, 5133, 5134, 5135], 'E'),
            createSector('E', 'north', 'east', [5141, 5142, 5143, 5144, 5145], 'E'),
            createSector('E', 'south', 'west', [5231, 5232, 5233, 5234, 5235], 'E'),
            createSector('E', 'south', 'east', [5241, 5242, 5243, 5244, 5245], 'E'),
        ],
    },
    {
        regionId: 'WestField',
